...
$.getJSON('https://spreadsheets.google.com/feeds/list/1lwnfa-GlNRykWBL5y7tWpLxDoCfs8BvzWxFjeOZ1YJk/1/public/values?alt=json',
            function(data) {
                ...
                + "<div class=\"cov_name_country_top1 col-sm-4\">" + data.feed.entry[0].gsx$l.$t + "</div>"
                ...
                + "<div class=\"cov_name_country_top2 col-sm-4\">" + data.feed.entry[1].gsx$l.$t + "</div>"
                ...
                + "<div class=\"cov_name_country_top3 col-sm-4\">" + data.feed.entry[2].gsx$l.$t + "</div>"
                ...
                for(let i = 4; i < data.feed.entry.length; i++) {
                    ...
                    + "<div class=\"cov_name_country col-sm-4\">" + data.feed.entry[i].gsx$l.$t + "</div>"

!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        const s = (t,e)=>(t.connect = e.connect.bind(e),
    ...
    , function(t, e, n) {
        ...
        const On = Object(k.a)(new Map, new WeakMap)
          ...
          , Ii = (Object(Mt.a)(ft.a, _e.a, He.a, Gs, An),
        Object(L.a)(_e.a, Cn))
          , Fi = Object(Ce.a)(Un, On, En, Si, Ps, yn.a, Qn, Zn)
          , Vi = (Object(Et.a)(On, ft.a, Ii, Gs, Fi),
              ...
              , T = function() {
                ...
                return s(t, [{
                    ...
                    value: function(t) {
                        ...
                        if (m(t) || g(t)) {
                            ...
                            m(t)) {
                                ...
                                void 0 !== c && w(c) && this._automationEvents.push(r(this.getValue(e), e)),
                            ...
                            if (-1 === T)
                                ...
                                if (p(t) && e + t.duration > v(this._automationEvents[T]))
                                    return !1;
                    ...
                    value: function(t) {
                        ...
                        if (e > 1) {
                            var n = this._automationEvents.slice(e - 1)
                              , s = n[0];
                            w(s) && n.unshift(r(f(this._automationEvents, e - 2, s.startTime, this._defaultValue), s.startTime)),
                    ...
                    value: function(t) {
                        ...
                        if (void 0 !== o && w(o) && (void 0 === i || !l(i) || i.insertTime > t))
                            return c(t, f(this._automationEvents, s - 2, o.startTime, this._defaultValue), o);
                        if (void 0 !== o && d(o) && (void 0 === i || !l(i)))
                            return o.value;
                        if (void 0 !== o && p(o) && (void 0 === i || !l(i) || o.startTime + o.duration > t))
                            return t < o.startTime + o.duration ? x(t, o) : o.values[o.values.length - 1];
          ...
          , r = (t,e,n,r,a,c,u,h)=>{
            ...
            return class d {
                constructor(d) {
                    ...
                    const {length: p, numberOfChannels: f, sampleRate: _} = {
                        ...o,
                        ...d
                    };
                    ...
                    if (0 === m.numberOfChannels)
                        throw n();
                    return "function" != typeof m.copyFromChannel ? (u(m),
                    Object(i.a)(m)) : e(s.a, ()=>Object(s.a)(m)) || h(m),
                    t.add(m),
                    m
                }
            ...
            return {
                ...
                render(u, h, l) {
                    ...
                    return void 0 !== d ? Promise.resolve(d) : (async(u,h,l)=>{
                        ...
                        return r.set(h, d),
                        p ? await t(h, u.playbackRate, d.playbackRate, l) : await i(h, u.playbackRate, d.playbackRate, l),
                        await o(u, h, d, l),
                        d
                    }
                    )(u, h, l)
        ...
        const i = (t,e,n,i,o,r,a,c,u)=>class extends t {
            constructor(t={}) {
                ...
                const {latencyHint: o} = t
                  , {sampleRate: r} = e;
                if (this._baseLatency = "number" == typeof e.baseLatency ? e.baseLatency : "balanced" === o ? 512 / r : "interactive" === o || void 0 === o ? 256 / r : "playback" === o ? 1024 / r : 128 * Math.max(2, Math.min(128, Math.round(o * r / 128))) / r,
        ...
        const i = (t,e,n,i,o,r,a,c,u,h,l,d)=>(p,f,_,m=null,g=null)=>{
            const v = new s.AutomationEventList(_.defaultValue)
              ...
              , b = {
                ...
                set value(t) {
                    _.value = t,
                    b.setValueAtTime(t, p.context.currentTime)
                },
                cancelAndHoldAtTime(t) {
                    if ("function" == typeof _.cancelAndHoldAtTime)
                        ...
                        e !== n && void 0 !== n && ("exponentialRampToValue" === n.type ? _.exponentialRampToValueAtTime(n.value, n.endTime) : "linearRampToValue" === n.type ? _.linearRampToValueAtTime(n.value, n.endTime) : "setValue" === n.type ? _.setValueAtTime(n.value, n.startTime) : "setValueCurve" === n.type && _.setValueCurveAtTime(n.values, n.startTime, n.duration))
                    }
                    return b
                },
                cancelScheduledValues: t=>(null === y && v.flush(p.context.currentTime),
                v.add(r(t)),
                _.cancelScheduledValues(t),
                b),
                exponentialRampToValueAtTime: (t,e)=>(null === y && v.flush(p.context.currentTime),
                v.add(a(t, e)),
                _.exponentialRampToValueAtTime(t, e),
                b),
                linearRampToValueAtTime: (t,e)=>(null === y && v.flush(p.context.currentTime),
                v.add(c(t, e)),
                _.linearRampToValueAtTime(t, e),
                b),
                setTargetAtTime: (t,e,n)=>(null === y && v.flush(p.context.currentTime),
                v.add(u(t, e, n)),
                _.setTargetAtTime(t, e, n),
                b),
                setValueAtTime: (t,e)=>(null === y && v.flush(p.context.currentTime),
                v.add(h(t, e)),
        ...
        const i = {
          ...
          , o = (t,e,n,o,r,a,c)=>class extends t {
            constructor(t, o=i) {
                ...
                this._detune = e(this, d, l.detune, 1200 * Math.log2(s.b), -1200 * Math.log2(s.b)),
            ...
            return {
                render(a, c, u) {
                    ...
                    return void 0 !== h ? Promise.resolve(h) : (async(a,c,u)=>{
                        ...
                        await t(c, a.gain, h.gain, u)) : (await i(c, a.Q, h.Q, u),
    ...
    , function(t, e, n) {
        ...
        const s = (t,e)=>(n,s)=>{
            ...
            try {
                const i = s();
                return i instanceof Promise ? (t.set(n, i),
                i.catch(()=>!1).then(s=>(t.delete(n),
                e.set(n, s),
                s))) : (e.set(n, i),
                i)
            } catch {
            ...
            return {
                ...
                render(u, h, l) {
                    ...
                    return void 0 !== d ? Promise.resolve(d) : (async(u,h,l)=>{
                        ...
                        return r.set(h, d),
                        p ? await t(h, u.offset, d.offset, l) : await i(h, u.offset, d.offset, l),
                        await o(u, h, d, l),
                        d
                    }
                    )(u, h, l)
            ...
            return {
                render(r, a, c) {
                    ...
                    return void 0 !== u ? Promise.resolve(u) : (async(r,a,c)=>{
                        ...
                        return o.set(a, u),
                        Object(s.a)(u) ? await n(r, a, u.inputs[0], c) : await n(r, a, u, c),
                        u
                    }
                    )(r, a, c)
                }
            ...
            return {
                render(c, u, h) {
                    ...
                    return void 0 !== l ? Promise.resolve(l) : (async(c,u,h)=>{
                        ...
                        return a.set(u, l),
                        d ? await t(u, c.delayTime, l.delayTime, h) : await i(u, c.delayTime, l.delayTime, h),
                        await o(c, u, l, h),
                        l
                    }
                    )(c, u, h)
            ...
            return {
                render(a, c, u) {
                    ...
                    return void 0 !== h ? Promise.resolve(h) : (async(a,c,u)=>{
                        ...
                        await t(c, a.threshold, h.threshold, u)) : (await i(c, a.attack, h.attack, u),
    ...
    , function(t, e, n) {
        ...
        const s = t=>e=>new Promise((n,s)=>{
            ...
            if (null === i)
                ...
                ;
                t.onerror = (e,n,i,o,r)=>n === a || n === t.location.href && 1 === i && 1 === o ? (u(),
                s(r),
                !1) : null !== c ? c(e, n, i, o, r) : void 0,
                o.onerror = ()=>{
                    u(),
                    s(new SyntaxError)
                }
            ...
            return {
                render(a, c, u) {
                    ...
                    return void 0 !== h ? Promise.resolve(h) : (async(a,c,u)=>{
                        ...
                        return r.set(c, h),
                        l ? await t(c, a.gain, h.gain, u) : await i(c, a.gain, h.gain, u),
                        await o(a, c, h, u),
                        h
                    }
                    )(a, c, u)
    ...
    , function(t, e, n) {
        ...
        const o = (t,e,n,o,r,a)=>(c,u)=>{
            ...
            const d = async(d,p,f)=>{
                ...
                if (void 0 === p.createIIRFilter ? _ = t(p) : g || (m = e(p, t=>t.createIIRFilter(u, c))),
                h.set(p, null === _ ? m : _),
                null !== _) {
                    if (null === l) {
                        if (null === o)
                        ...
                        l = (async()=>(await r(d, t, t.destination, f),
                        ((t,e,n,i)=>{
                            const o = n.length
                              , r = i.length
                              , a = Math.min(o, r);
        ...
        const i = (t,e,n,i,o)=>class extends i {
            constructor(t={}) {
                ...
                const {latencyHint: r} = t
                  , {sampleRate: a} = i;
                if (this._baseLatency = "number" == typeof i.baseLatency ? i.baseLatency : "balanced" === r ? 512 / a : "interactive" === r || void 0 === r ? 256 / a : "playback" === r ? 1024 / a : 128 * Math.max(2, Math.min(128, Math.round(r * a / 128))) / a,
    ...
    , function(t, e, n) {
        ...
        const i = {
          ...
          , o = (t,e,n,o,r)=>class extends o {
            constructor(e) {
                const {length: o, numberOfChannels: r, sampleRate: a} = {
                    ...i,
                    ...e
                }
                  , c = n(r, o, a);
            ...
            startRendering() {
                ...
                r(this.destination, this._nativeOfflineAudioContext).then(t=>(this._state = null,
                t)).catch(t=>{
    ...
    , function(t, e, n) {
        ...
        const s = (t,e)=>(n,s,i)=>{
            const o = new Set;
            var r, a;
            return n.connect = (r = n.connect,
            (i,a=0,c=0)=>{
                const u = 0 === o.size;
                if (e(i))
                    return r.call(n, i, a, c),
            ...
            (t,s,r)=>{
                ...
                if (void 0 === t)
                    ...
                    for (const e of o)
                        e[0] !== t || void 0 !== s && e[1] !== s || void 0 !== r && e[2] !== r || o.delete(e)
                }
                const u = 0 === o.size;
                c && u && i()
            }
    ...
    , function(t, e, n) {
        ...
        const i = (t,e)=>(n,i)=>{
            ...
            return 1 !== o.channelCount && "explicit" !== o.channelCountMode && e(n, o),
            Object(s.a)(o, i),
            o
        }
    }
    ...
    , function(t, e, n) {
        ...
        const i = (t,e,n,i)=>(o,{offset: r, ...a})=>{
            ...
            return t(o, u),
            i(Object(s.a)(d, h), ()=>u.connect(h), ()=>u.disconnect(h))
        }
    }
    , function(t, e, n) {
        "use strict";
    ...
    , function(t, e, n) {
        ...
        const o = (t,e)=>(n,o)=>{
            ...
            o.channelCount > 2)
                throw e();
            if ("max" === o.channelCountMode)
                throw e();
            return Object(s.a)(r, o, "attack"),
            Object(s.a)(r, o, "knee"),
            ...
            const O = u.sampleRate / 2
              , S = {
                ...
                getFrequencyResponse(e, n, s) {
                    if (e.length !== n.length || n.length !== s.length)
                        throw t();
                    const i = e.length;
                    for (let t = 0; t < i; t += 1) {
    ...
    , function(t, e, n) {
        ...
        const i = (t,e)=>(n,i)=>{
            ...
            1 === o.numberOfOutputs && Object.defineProperty(o, "numberOfOutputs", {
                get: ()=>0
            }),
            o
        }
    ...
    , function(t, e, n) {
        ...
        const c = (t,e,n,c,u,h,l)=>(d,p)=>{
            ...
            return Object(o.a)(f, p),
            Object(s.a)(f, p, "detune"),
            Object(s.a)(f, p, "frequency"),
            void 0 !== p.periodicWave ? f.setPeriodicWave(p.periodicWave) : Object(i.a)(f, p, "type"),
    ...
    , function(t, e, n) {
        ...
        const r = (t,e)=>(n,r)=>{
            ...
            return void 0 === a.orientationX ? e(n, r) : (Object(o.a)(a, r),
    ...
    , function(t, e, n) {
        ...
        const o = (t,e,n)=>(o,r)=>t(o, t=>{
            ...
            if ("clamped-max" === a)
                throw n();
            if (void 0 === o.createStereoPanner)
                return e(o, r);
            const c = t.createStereoPanner();
            return Object(i.a)(c, r),
            Object(s.a)(c, r, "pan"),
    ...
    , function(t, e, n) {
        ...
        const o = (t,e,n,o,r,a,c)=>(u,h)=>{
            ...
            if (null !== d && d.length < 2)
                throw e();
            Object(s.a)(l, h, "curve"),
            Object(s.a)(l, h, "oversample");
            let p = null
              , f = !1;
            c(l, "curve", t=>()=>t.call(l), e=>n=>(e.call(l, n),
            f && (r(n) && null === p ? p = t(u, l) : r(n) || null === p || (p(),
            p = null)),
            n));
            return a(l, ()=>{
                f = !0,
                    ...
                    if (null === n)
                        ...
                        for (let r = 1; r < i; r += 1) {
                            const a = r / i * o
                              , c = Math.floor(a)
                              , u = Math.ceil(a);
                            e[r] = c === u ? n[c] : (1 - (a - c)) * n[c] + (1 - (u - a)) * n[u],
                            s[r] = c === u ? -n[t - 1 - c] : -(1 - (a - c)) * n[t - 1 - c] - (1 - (u - a)) * n[t - 1 - u]
                        }
        ...
        const o = {
          ...
          , r = (t,e,n,r,a,c,u,h)=>class extends t {
            constructor(t, n=o) {
                ...
                null !== this._oscillatorNodeRenderer && void 0 !== i.periodicWave && (this._oscillatorNodeRenderer.periodicWave = i.periodicWave)
            }
            get detune() {
                return this._detune
            }
            ...
            return {
                ...
                render(h, l, d) {
                    ...
                    return void 0 !== p ? Promise.resolve(p) : (async(h,l,d)=>{
                        ...
                        await t(l, h.frequency, p.frequency, d)) : (await i(l, h.detune, p.detune, d),
            ...
            return {
                render(f, _, m) {
                    ...
                    return void 0 !== g ? Promise.resolve(g) : (async(f,_,m)=>{
                        ...
                        return x ? (await t(_, f.orientationX, v.orientationX, m),
                        ...
                        await t(_, f.positionZ, v.positionZ, m)) : (await u(_, f.orientationX, v.orientationX, m),
                        ...
                        Object(s.a)(v) ? await h(f, _, v.inputs[0], m) : await h(f, _, v, m),
                        v
                    }
                    )(f, _, m)
                }
    ...
    , function(t, e, n) {
        ...
        const s = (t,e)=>(n,s,i,o)=>(t(s).replay(i),
        e(s, n, i, o))
    }
    , function(t, e, n) {
        "use strict";
    ...
    , function(t, e, n) {
        ...
        const i = (t,e,n,i,o,r,a,c)=>{
            const u = [];
            return (h,l)=>n(h).render(h, l, u).then(()=>Promise.all(Array.from(i(l)).map(t=>n(t).render(t, l, u)))).then(()=>o(l)).then(n=>("function" != typeof n.copyFromChannel ? (a(n),
            Object(s.a)(n)) : e(r, ()=>r(n)) || c(n),
            t.add(n),
            n))
        }
    }
            ...
            return {
                render(c, u, h) {
                    ...
                    return void 0 !== l ? Promise.resolve(l) : (async(c,u,h)=>{
                        ...
                        return a.set(u, l),
                        d ? await t(u, c.pan, l.pan, h) : await o(u, c.pan, l.pan, h),
                        Object(s.a)(l) ? await r(c, u, l.inputs[0], h) : await r(c, u, l, h),
                        l
                    }
                    )(c, u, h)
                }
        ...
        const s = t=>e=>{
            ...
            (s,i,o=0)=>{
                const r = t(o)
                  , a = t(i);
                if (r < e.length)
                    return n.call(e, s, a, r)
            }
            ),
            e.copyToChannel = (s = e.copyToChannel,
            (n,i,o=0)=>{
                const r = t(o)
                  , a = t(i);
                if (r < e.length)
    ...
    , function(t, e, n) {
        ...
        const k = (t,e,[n,s,i],o)=>{
          ...
          , R = (t,e,n,s)=>{
            ...
            ;
            return !!Object(m.a)(r, [e, n, s], t=>t[0] === e && t[1] === n && t[2] === s, !0) && (u.add(d),
            ...
            const {activeInputs: s, passiveInputs: i} = Object(d.a)(e)
              ...
              , a = o=>{
                ...
                if (o) {
                    const e = E(i, t, n);
                    A(s, t, e, !1),
                    Object(v.a)(t) || r.connect(a, n)
                } else {
                    const e = ((t,e,n)=>b(t, t=>t[0] === e && t[1] === n))(s, t, n);
                    M(i, e, !1),
                    Object(v.a)(t) || r.disconnect(a, n)
                }
            }
            ;
            return !!Object(m.a)(o, [e, n], t=>t[0] === e && t[1] === n, !0) && (r.add(a),
          ...
          , F = (t,e,n,s)=>{
            ...
            if (null !== i && (u(t, i),
            o && !Object(v.a)(t) && Object(h.a)(Object(p.a)(t), Object(p.a)(e), n, s)),
            Object(g.a)(e)) {
          ...
          , V = (t,e,n)=>{
            ...
            null !== s && (u(t, s),
            i && !Object(v.a)(t) && Object(p.a)(t).disconnect(Object(f.a)(e), n))
        }
          , N = (t,e,n,c,u,h,_,g,v,b,w,T,D,M,j)=>class extends b {
            constructor(e, i, o, r) {
                super(o),
                this._context = e,
                this._nativeAudioNode = o;
                const a = w(e);
                T(a) && !0 !== n(O, ()=>O(a)) && (t=>{
                    const e = new Map;
                    var n, s;
            ...
            connect(t, n=0, s=0) {
                ...
                if (Object(i.a)(t)) {
                    ...
                    try {
                        ...
                        if (g || y(this) ? this._nativeAudioNode.disconnect(...c) : y(t) && Object(x.a)(t),
                        r(t)) {
                            const t = e.get(i);
                            if (void 0 === t) {
                ...
                if (void 0 === t)
                    ...
                    s = ((t,e)=>{
                        ...
                        for (const i of n.outputs)
                            i[1] === e && (Object(o.a)(i) ? F(t, ...i) : V(t, ...i),
                            s.push(i[0]),
                            n.outputs.delete(i));
                        return s
                    }
                    ...
                    if (void 0 !== e && (e < 0 || e >= this.numberOfOutputs))
                        throw u();
                    if (Object(i.a)(t) && void 0 !== n && (n < 0 || n >= t.numberOfInputs))
                        throw u();
                    if (s = ((t,e,n,s)=>{
                        const i = Object(l.a)(t);
                        return Array.from(i.outputs).filter(t=>!(t[0] !== e || void 0 !== n && t[1] !== n || void 0 !== s && t[2] !== s)).map(e=>(Object(o.a)(e) ? F(t, ...e) : V(t, ...e),
                        i.outputs.delete(e),
                        e[0]))
                    }
                    )(this, t, e, n),
    ...
    , function(t, e, n) {
        ...
        const l = (t,e,n,l,d,p,f,_,m,g,v,y,b)=>(x,w,T,O)=>{
            if (0 === O.numberOfInputs && 0 === O.numberOfOutputs)
                throw g();
            if (void 0 !== O.outputChannelCount) {
                if (O.outputChannelCount.some(t=>t < 1))
                    throw g();
                if (O.outputChannelCount.length !== O.numberOfOutputs)
                    throw n()
            }
            if ("explicit" !== O.channelCountMode)
                throw g();
            ...
            if (void 0 !== T.parameterDescriptors)
                for (const {defaultValue: t, maxValue: e, minValue: n, name: i} of T.parameterDescriptors) {
                    const o = f(x, {
                        channelCount: 1,
                        channelCountMode: "explicit",
                        channelInterpretation: "discrete",
            ...
            const L = 0 === O.numberOfOutputs ? [q] : F
              , z = {
                ...
                set onprocessorerror(t) {
                    "function" == typeof P && z.removeEventListener("processorerror", P),
                    P = "function" == typeof t ? t : null,
                    "function" == typeof P && z.addEventListener("processorerror", P)
                },
                get parameters() {
                    return V
                },
              ...
              , B = new Map;
            var W, U;
            A.port1.addEventListener = (W = A.port1.addEventListener,
            (...t)=>{
                if ("message" === t[0]) {
            ...
            A.port1.removeEventListener = (U = A.port1.removeEventListener,
            (...t)=>{
                if ("message" === t[0]) {
                    const e = B.get(t[1]);
                    void 0 !== e && (B.delete(t[1]),
                    t[1] = e)
                }
            ...
            Object.defineProperty(A.port1, "onmessage", {
                ...
                set: t=>{
                    ...
                    "function" == typeof G && (A.port1.addEventListener("message", G),
                    A.port1.start())
                }
            }),
                ...
                if (null !== Y)
                    for (let s = 0; s < R; s += 128) {
                        ...
                        try {
                            ...
                            H = !1,
                            z.dispatchEvent(new ErrorEvent("processorerror",{
                                error: t
                            }))
                        }
                        if (!H) {
                            ...
                            if (void 0 !== T.parameterDescriptors) {
                                ...
                                for (let e = 0; e < t; e += 1) {
                                    const t = j[e];
                                    t.disconnect(E, 0, S + e),
                                    t.stop()
                                }
                            }
                            E.disconnect(q),
                            q.onaudioprocess = null,
                            J ? $() : et();
                            break
                        }
                    }
            ...
            b(z, ()=>{
                if (H) {
                    et(),
                    O.numberOfOutputs > 0 && q.connect(I);
                    for (let t = 0, e = 0; t < O.numberOfOutputs; t += 1) {
                        const n = F[t];
                        for (let s = 0; s < O.outputChannelCount[t]; s += 1)
                            I.connect(n, e + s, s);
    ...
    , function(t, e, n) {
        ...
        const i = {
          ...
          , u = (t,e,n,i,o,u,h,l,d)=>(p,f,_={
            ...
            return void 0 === y ? h.set(p, new Map([[f, b]])) : y.set(f, b),
            b.then(()=>{
                const t = l.get(p);
    ...
    , function(t, e, n) {
        ...
        const l = async(t,e,n,h,l,d)=>{
            ...
            const g = Object(r.a)(t)
              ...
              , x = Array.from(t.parameters.keys()).reduce((t,e)=>({
                ...t,
                [e]: new Float32Array(128)
            }), {});
            ...
            if (null !== c)
                try {
                    ...
                    0 !== l.numberOfOutputs) {
                        ...
                        o(n, ()=>t.disconnect(), ()=>t.connect(t.context.destination))
                    }
                    return n
                } catch (t) {
                    if (11 === t.code)
        ...
        t.exports = function(t, e) {
            if ("undefined" != typeof Symbol && Symbol.iterator in Object(t)) {
                var n = []
                  ...
                  , o = void 0;
                try {
                    for (var r, a = t[Symbol.iterator](); !(s = (r = a.next()).done) && (n.push(r.value),
                    !e || n.length !== e); s = !0)
                        ;
                } catch (t) {
                    i = !0,
    ...
    , function(t, e, n) {
        ...
        function O(t, e, n, s) {
            ...
            return o > 3 && r && Object.defineProperty(e, n, r),
            r
        }
        function S(t, e, n, s) {
        ...
        function R(t, ...e) {
            ...
            if (g(t) && g(n))
                for (const e in n)
                    E(e, n[e]) ? t[e] = n[e] : g(n[e]) ? (t[e] || Object.assign(t, {
                        [e]: {}
                    }),
 ...
 */
        ...
        class W extends V {
            ...
            add(t) {
                if (r(Reflect.has(t, "time"), "Timeline: events must have a time attribute"),
                t.time = t.time.valueOf(),
                this.increasing && this.length) {
                    const e = this._timeline[this.length - 1];
                    r(P(t.time, e.time), "The time must be greater than or equal to the last scheduled time"),
            ...
            cancel(t) {
                if (this._timeline.length > 1) {
                    ...
                    1 === this._timeline.length && P(this._timeline[0].time, t) && (this._timeline = []);
                return this
            }
            cancelBefore(t) {
            ...
            forEachBetween(t, e, n) {
                let s = this._search(t)
                  , i = this._search(e);
                return -1 !== s && -1 !== i ? (this._timeline[s].time !== t && (s += 1),
                this._timeline[i].time === e && (i -= 1),
                this._iterate(n, s, i)) : -1 === s && this._iterate(n, 0, i),
                this
            }
            forEachFrom(t, e) {
            ...
            forEachAtTime(t, e) {
                ...
                if (-1 !== n && z(this._timeline[n].time, t)) {
                    let s = n;
                    for (let e = n; e >= 0 && z(this._timeline[e].time, t); e--)
                        s = e;
                    this._iterate(t=>{
                        e(t)
                    }
        ...
        class Z extends V {
            ...
            off(t, e) {
                return t.split(/\W+/).forEach(n=>{
                    if (p(this._events) && (this._events = {}),
        ...
        class H extends X {
            constructor() {
                ...
                this._ticker = new C(this.emit.bind(this, "tick"),t.clockSource,t.updateInterval),
            ...
            createMediaStreamSource(t) {
                return r(M(this._context), "Not available if OfflineAudioContext"),
            ...
            set listener(t) {
                r(!this._initialized, "The listener cannot be set after initialization."),
                this._listener = t
            }
            get transport() {
                return this.initialize(),
            ...
            set transport(t) {
                r(!this._initialized, "The transport cannot be set after initialization."),
                this._transport = t
            }
            get draw() {
                return this.initialize(),
            ...
            set destination(t) {
                r(!this._initialized, "The destination cannot be set after initialization."),
                this._destination = t
            }
            createAudioWorkletNode(t, e) {
                return function(t, e, n) {
                    return r(f(o.AudioWorkletNode), "This node only works in a secure context (https or localhost)"),
...
***************************************************************************** */
            ...
            addAudioWorkletModule(t, e) {
                return S(this, void 0, void 0, (function*() {
                    r(f(this.rawContext.audioWorklet), "AudioWorkletNode is only available in a secure context (https or localhost)"),
        ...
        class tt extends V {
            constructor() {
                ...
                t.url && j(t.url) || t.url instanceof tt ? this.set(t.url) : b(t.url) && this.load(t.url).catch(t.onerror)
            }
            static getDefaults() {
                return {
                    onerror: K,
        ...
        class et extends H {
            constructor() {
                ...
                super({
                    clockSource: "offline",
                    context: D(arguments[0]) ? arguments[0] : (t = arguments[0],
                ...
                this._currentTime = 0,
                this.isOffline = !0,
                this._duration = D(arguments[0]) ? arguments[0].length / arguments[0].sampleRate : arguments[1]
            }
            now() {
        ...
        class ft extends V {
                ...
                return {
                    ...
                    tr: {
                        method: (t,e,n)=>{
                            ...
                            n && "0" !== n && (s += this._beatsToUnits(parseFloat(n) / 4)),
                            s
                        }
                        ,
                        regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?$/
            ...
            valueOf() {
                if (this._val instanceof ft && this.fromType(this._val),
                p(this._val))
                    return this._noArg();
        ...
        class St extends Tt {
            constructor() {
                ...
                for (r(f(t.param) && (k(t.param) || t.param instanceof St), "param must be an AudioParam"); !k(t.param); )
                ...
                f(t.value) && t.value !== this._toType(this._initialValue) && this.setValueAtTime(t.value, 0)
            }
            static getDefaults() {
            ...
            _assertRange(t) {
                return f(this.maxValue) && f(this.minValue) && a(t, this._fromType(this.minValue), this._fromType(this.maxValue)),
                t
            }
            _fromType(t) {
            ...
            setValueAtTime(t, e) {
                const n = this.toSeconds(e)
                  , s = this._fromType(t);
                return r(isFinite(s) && isFinite(n), `Invalid argument(s) to setValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`),
                this._assertRange(s),
            ...
            getValueAtTime(t) {
                ...
                if (null === s)
                    ...
                    "setTargetAtTime" === s.type && (i = this._exponentialApproach(s.time, n, s.value, s.constant, e))
                }
            ...
            linearRampToValueAtTime(t, e) {
                const n = this._fromType(t)
                  , s = this.toSeconds(e);
                return r(isFinite(n) && isFinite(s), `Invalid argument(s) to linearRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`),
                this._assertRange(n),
                this._events.add({
                    time: s,
            ...
            exponentialRampToValueAtTime(t, e) {
                ...
                return r(isFinite(n) && isFinite(s), `Invalid argument(s) to exponentialRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`),
                this._events.add({
                    time: s,
            ...
            exponentialApproachValueAtTime(t, e, n) {
                ...
                return this.setTargetAtTime(t, e, s),
            ...
            setTargetAtTime(t, e, n) {
                ...
                r(isFinite(s) && isFinite(i), `Invalid argument(s) to setTargetAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`),
                this._events.add({
                    constant: n,
                    time: i,
            ...
            cancelScheduledValues(t) {
                ...
                return r(isFinite(e), "Invalid argument to cancelScheduledValues: " + JSON.stringify(t)),
            ...
            cancelAndHoldAtTime(t) {
                ...
                r(isFinite(e), "Invalid argument to cancelAndHoldAtTime: " + JSON.stringify(t)),
                this.log(this.units, "cancelAndHoldAtTime", e, "value=" + n);
                const s = this._events.get(e)
                  , i = this._events.getAfter(e);
                return s && z(s.time, e) ? i ? (this._param.cancelScheduledValues(i.time),
                ...
                "linearRampToValueAtTime" === i.type ? this.linearRampToValueAtTime(this._toType(n), e) : "exponentialRampToValueAtTime" === i.type && this.exponentialRampToValueAtTime(this._toType(n), e)),
                this._events.add({
                    time: e,
                    type: "setValueAtTime",
                    value: n
        ...
        class Ct extends Tt {
            ...
            toMaster() {
                return d("toMaster() has been renamed toDestination()"),
                this.toDestination()
            }
            ...
            dispose() {
                return super.dispose(),
                f(this.input) && (this.input instanceof Ct ? this.input.dispose() : A(this.input) && this.input.disconnect()),
                f(this.output) && (this.output instanceof Ct ? this.output.dispose() : A(this.output) && this.output.disconnect()),
                this._internalChannels = [],
                this
            }
        }
        function kt(...t) {
            const e = t.shift();
            t.reduce((t,e)=>(t instanceof Ct ? t.connect(e) : A(t) && At(t, e),
            e), e)
        }
        function At(t, e, n=0, s=0) {
            for (r(f(t), "Cannot connect from undefined node"),
            r(f(e), "Cannot connect to undefined node"),
            (e instanceof Ct || A(e)) && r(e.numberOfInputs > 0, "Cannot connect to node with no inputs"),
            r(t.numberOfOutputs > 0, "Cannot connect from node with no outputs"); e instanceof Ct || e instanceof St; )
                f(e.input) && (e = e.input);
            for (; t instanceof Ct; )
                f(t.output) && (t = t.output);
        ...
        class jt extends Ct {
            ...
            _onended() {
                this.onended !== K && (this.onended(this),
                this.onended = K,
        ...
        class Rt extends Ct {
            ...
            setValueCurveAtTime(t, e, n, s) {
                return this._param.setValueCurveAtTime(t, e, n, s),
                this
            }
            cancelScheduledValues(t) {
        ...
        function qt(t, e, n, s) {
            (e instanceof St || k(e) || e instanceof Rt && e.override) && (e.cancelScheduledValues(0),
        ...
        class It extends St {
            ...
            _getTicksUntilEvent(t, e) {
                ...
                return i && i.time === e && "setValueAtTime" === i.type && (s = this._fromType(this.getValueAtTime(e - this.sampleTime))),
                .5 * (e - t.time) * (n + s) + t.ticks
            }
            getTicksAtTime(t) {
                const e = this.toSeconds(t)
        ...
        class Vt extends Tt {
            ...
            getSecondsAtTime(t) {
                ...
                return this._state.forEachBetween(e.time, t + this.sampleTime, t=>{
                    let e = s.time;
                    const n = this._tickOffset.get(t.time);
                    n && n.time >= s.time && (i = n.seconds,
                    e = n.time),
                    "started" === s.state && "started" !== t.state && (i += t.time - e),
                    s = t
                }
                ),
            ...
            forEachTickBetween(t, e, n) {
                ...
                this._state.forEachBetween(t, e, e=>{
                    s && "started" === s.state && "started" !== e.state && this.forEachTickBetween(Math.max(s.time, t), e.time - this.sampleTime, n),
                    s = e
                }
                );
                let i = null;
        ...
        class Gt extends Ut {
            ...
            _createEvents(t) {
                ...
                this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new Lt(this.context,this._nextTick).toSeconds()))
            }
            _restart(t) {
                ...
                this._currentId = this.transport.scheduleOnce(this.invoke.bind(this), new Lt(this.context,this._nextTick).toSeconds()),
        ...
        class Yt extends Tt {
            ...
            _bindClockEvents() {
                this._clock.on("start", (t,e)=>{
                    e = new Lt(this.context,e).toSeconds(),
                    this.emit("start", t, e)
                }
                ),
        ...
        class $t extends V {
            ...
            get(t) {
                return r(this.has(t), "ToneAudioBuffers has no buffer named: " + t),
            ...
            add(t, e, n=K, s=K) {
                return b(e) ? this._buffers.set(t.toString(), new tt(this.baseUrl + e,n,s)) : this._buffers.set(t.toString(), new tt(e,n,s)),
                this
            }
            dispose() {
                return super.dispose(),
        ...
        class ne extends Ct {
            ...
            start(t, e, n) {
                ...
                this._synced || "started" !== this._state.getValueAtTime(s))
                    ...
                    this._synced) {
                        ...
                        "started" === this.context.transport.state && this.context.transport.getSecondsAtTime(this.immediate()) > s && this._syncedStart(this.now(), this.context.transport.seconds)
                    } else
                        c(this.context),
                        this._start(s, e, n);
                else
                    r(N(s, this._state.get(s).time), "Start time must be strictly greater than previous start time"),
            ...
            stop(t) {
                ...
                "started" === this._state.getValueAtTime(e) || f(this._state.getNextState("started", e))) {
                    if (this.log("stop", e),
                    this._synced) {
        ...
        class se extends jt {
            ...
            start(t, e, n, s=1) {
                ...
                L(o, this.buffer.duration) && (this._sourceStarted = !0,
        ...
        class ie extends ne {
            ...
            set type(t) {
                if (r(t in re, "Noise: invalid type: " + t),
        ...
        class ae extends Ct {
            ...
            open(t) {
                return S(this, void 0, void 0, (function*() {
                    ...
                    m(t) ? this._device = e[t] : (this._device = e.find(e=>e.label === t || e.deviceId === t),
        ...
        class he extends ne {
            ...
            _getRealImaginary(t, e) {
                ...
                for (let r = 1; r < n; ++r) {
                    ...
                    0 !== a ? (s[r] = -a * Math.sin(e * r),
                    i[r] = a * Math.cos(e * r)) : (s[r] = 0,
                    i[r] = 0)
                }
                return [s, i]
            }
        ...
        class de extends le {
            constructor() {
                super(Object.assign(q(de.getDefaults(), arguments, ["mapping", "length"]))),
            ...
            set oversample(t) {
                r(["none", "2x", "4x"].some(e=>e.includes(t)), "oversampling must be either 'none', '2x', or '4x'"),
        ...
        class _e extends ne {
            constructor() {
                super(q(_e.getDefaults(), arguments, ["frequency", "type", "modulationType"])),
        ...
        class me extends ne {
            constructor() {
                super(q(me.getDefaults(), arguments, ["frequency", "type", "modulationType"])),
        ...
        class ve extends ne {
            constructor() {
                super(q(ve.getDefaults(), arguments, ["frequency", "type", "spread"])),
        ...
        class ye extends ne {
            constructor() {
                super(q(ye.getDefaults(), arguments, ["frequency", "modulationFrequency"])),
        ...
        class Oe extends le {
            ...
            dispose() {
                return super.dispose(),
                Dt(this.context.getConstant(0), this._gain),
                this
            }
        }
        class Se extends Ct {
            ...
            connect(t, e, n) {
                return (t instanceof St || t instanceof Rt) && (this.convert = t.convert,
                this.units = t.units),
                qt(this, t, e, n),
                this
            }
        ...
        class Ae extends ne {
            ...
            _start(t, e, n) {
                ...
                this._loop && p(i) ? r.start(t, s) : r.start(t, s, o - this.toSeconds(this.fadeOut))
            }
            _stop(t) {
                const e = this.toSeconds(t);
        ...
        class De extends Ct {
            ...
            player(t) {
                if (r(this.has(t), `No Player with the name ${t} exists on this object`),
                !this._players.has(t)) {
                    const e = new Ae({
                        context: this.context,
                        fadeIn: this._fadeIn,
            ...
            add(t, e, n) {
                return r(!this._buffers.has(t), "A buffer with that name already exists on this object"),
        ...
        class Me extends ne {
            ...
            _tick(t) {
                const e = this._clock.getTicksAtTime(t)
                  , n = e * this._grainSize;
                if (this.log("offset", n),
                !this.loop && n > this.buffer.duration)
        ...
        class Ie extends le {
            constructor() {
                ...
                this._thresh = this.output = new de({
                    context: this.context,
                    length: 127,
                    mapping: t=>t <= 0 ? 0 : 1
                }),
        ...
        class Ne extends Te {
            constructor() {
                super(Object.assign(q(Ne.getDefaults(), arguments, ["min", "max", "exponent"]))),
                this.name = "ScaleExp";
        ...
        class Pe extends Rt {
            constructor() {
                ...
                this._constantSource = this.output = new Et({
                    context: this.context,
                    offset: t.value,
                    units: t.units
                }).start(0),
            ...
            setValueAtTime(t, e) {
                ...
                return super.setValueAtTime(t, n),
                this
            }
            linearRampToValueAtTime(t, e) {
                const n = new xt(this.context,e).toSeconds();
                return super.linearRampToValueAtTime(t, n),
                this
            }
            exponentialRampToValueAtTime(t, e) {
                const n = new xt(this.context,e).toSeconds();
                return super.exponentialRampToValueAtTime(t, n),
                this
            }
            setTargetAtTime(t, e, n) {
                const s = new xt(this.context,e).toSeconds();
                return super.setTargetAtTime(t, s, n),
                this
            }
            cancelScheduledValues(t) {
                const e = new xt(this.context,t).toSeconds();
            ...
            setValueCurveAtTime(t, e, n, s) {
                ...
                return n = this.toSeconds(n),
                super.setValueCurveAtTime(t, i, n, s),
                this
            }
            cancelAndHoldAtTime(t) {
                const e = new xt(this.context,t).toSeconds();
        ...
        class Le extends Ct {
            constructor() {
                super(q(Le.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])),
                this.name = "Envelope",
                this._sig = new Rt({
                    context: this.context,
                    value: 0
            ...
            set decayCurve(t) {
                r(["linear", "exponential"].some(e=>e === t), "Invalid envelope curve: " + t),
                this._decayCurve = t
            }
            triggerAttack(t, e=1) {
                ...
                if (s && this.sustain < 1) {
                    const i = e * this.sustain
                      , o = t + n;
                    this.log("decay", o),
                    "linear" === this._decayCurve ? this._sig.linearRampToValueAtTime(i, s + o) : this._sig.exponentialApproachValueAtTime(i, o, s)
                }
                return this
            }
            triggerRelease(t) {
                ...
                if (e > 0) {
                    ...
                    n < this.sampleTime ? this._sig.setValueAtTime(0, t) : "linear" === this._releaseCurve ? this._sig.linearRampTo(0, n, t) : "exponential" === this._releaseCurve ? this._sig.targetRampTo(0, n, t) : (r(y(this._releaseCurve), "releaseCurve must be either 'linear', 'exponential' or an array"),
                    this._sig.cancelAndHoldAtTime(t),
        ...
        class Be extends Ct {
            ...
            triggerAttackRelease(t, e, n, s) {
                const i = this.toSeconds(n)
                  , o = this.toSeconds(e);
                return this.triggerAttack(t, i, s),
        ...
        class We extends Be {
            ...
            triggerAttack(t, e, n=1) {
                ...
                const s = this.toSeconds(e);
                return this._triggerEnvelopeAttack(s, n),
                this.setNote(t, s),
                this
            }
            triggerRelease(t) {
        ...
        class Ue extends Le {
            constructor() {
                super(q(Ue.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])),
        ...
        class Ge extends We {
            constructor() {
                super(q(Ge.getDefaults(), arguments)),
                this.name = "Synth";
                ...
                this.envelope = new Ue(Object.assign({
                    context: this.context
                }, t.envelope)),
        ...
        class Ze extends Ct {
            ...
            set type(t) {
                r(-1 !== ["lowpass", "highpass", "bandpass", "lowshelf", "highshelf", "notch", "allpass", "peaking"].indexOf(t), "Invalid filter type: " + t),
                this._filter.type = t
            }
        ...
        class Xe extends Ct {
            constructor() {
                super(q(Xe.getDefaults(), arguments, ["frequency", "type", "rolloff"])),
                this.name = "Filter",
                this.input = new Mt({
                    context: this.context
                }),
        ...
        class He extends Le {
            constructor() {
                super(q(He.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])),
                ...
                this._exponent = this.input = new Ve({
                    context: this.context,
                    value: t.exponent
                }),
        ...
        class $e extends We {
            constructor() {
                super(q($e.getDefaults(), arguments)),
                this.name = "MonoSynth";
                ...
                $(this, ["oscillator", "frequency", "detune", "filter", "filterEnvelope", "envelope"])
            }
            static getDefaults() {
                return Object.assign(We.getDefaults(), {
                    envelope: Object.assign(F(Le.getDefaults(), Object.keys(Ct.getDefaults())), {
        ...
        class Je extends We {
            constructor() {
                super(q(Je.getDefaults(), arguments)),
                this.name = "DuoSynth";
                ...
                $(this, ["voice0", "voice1", "frequency", "vibratoAmount", "vibratoRate"])
            }
            getLevelAtTime(t) {
                return t = this.toSeconds(t),
        ...
        class Ke extends Ye {
            constructor() {
                super(q(Ke.getDefaults(), arguments)),
                this.name = "FMSynth";
        ...
        class nn extends Ge {
            ...
            setNote(t, e) {
                const n = this.toSeconds(e)
                  ...
                  , i = s * this.octaves;
                return this.oscillator.frequency.setValueAtTime(i, n),
                this.oscillator.frequency.exponentialRampToValueAtTime(s, n + this.toSeconds(this.pitchDecay)),
                this
            }
            dispose() {
                return super.dispose(),
        ...
        class sn extends Be {
            constructor() {
                super(q(sn.getDefaults(), arguments)),
        ...
        class cn extends Ct {
            constructor(t) {
                ...
                this.context.addAudioWorkletModule(e, n).then(()=>{
                    this.disposed || (this._worklet = this.context.createAudioWorkletNode(n, this.workletOptions),
        ...
        class hn extends Ct {
            ...
            getFrequencyResponse(t=128) {
                ...
                const n = new Float32Array(t)
                  , s = new Float32Array(t);
                return this._filter.getFrequencyResponse(e, n, s),
                n
            }
            dispose() {
                return super.dispose(),
        ...
        class ln extends Ct {
            constructor() {
                super(q(ln.getDefaults(), arguments, ["delayTime", "resonance", "dampening"])),
                ...
                this._lowpass = this.input = new hn({
                    context: this.context,
        ...
        class dn extends Be {
            constructor() {
                super(q(dn.getDefaults(), arguments)),
            ...
            triggerAttack(t, e) {
                ...
                e = this.toSeconds(e);
                const s = 1 / n;
                return this._lfcf.delayTime.setValueAtTime(s, e),
                this._noise.start(e),
        ...
        class pn extends Be {
            ...
            _scheduleEvent(t, e, n, s) {
                ...
                n <= this.now() ? "attack" === t ? this._triggerAttack(e, n, s) : this._triggerRelease(e, n) : this.context.setTimeout(()=>{
            ...
            triggerAttack(t, e, n) {
                Array.isArray(t) || (t = [t]);
                const s = this.toSeconds(e);
                return this._scheduleEvent("attack", t, s, n),
                this
            }
            triggerRelease(t, e) {
                Array.isArray(t) || (t = [t]);
                const n = this.toSeconds(e);
                return this._scheduleEvent("release", t, n),
                this
            }
            triggerAttackRelease(t, e, n, s) {
                const i = this.toSeconds(n);
                if (this.triggerAttack(t, i, s),
                y(e)) {
                    r(y(t), "If the duration is an array, the notes must also be an array"),
                    t = t;
                    for (let n = 0; n < t.length; n++) {
            ...
            set(t) {
                ...
                return this.options = R(this.options, e),
        ...
        class fn extends Be {
            constructor() {
                super(q(fn.getDefaults(), arguments, ["urls", "onload", "baseUrl"], "urls")),
                this.name = "Sampler",
                ...
                Object.keys(t.urls).forEach(n=>{
                    ...
                    if (r(x(n) || m(s) && isFinite(s), "url key is neither a note or midi pitch: " + n),
                    x(n)) {
                        const s = new gt(this.context,n).toMidi();
                        e[s] = t.urls[n]
                    } else
                        m(s) && isFinite(s) && (e[s] = t.urls[s])
                }
                ),
                this._buffers = new $t({
                    urls: e,
            ...
            triggerAttackRelease(t, e, n, s=1) {
                const i = this.toSeconds(n);
                return this.triggerAttack(t, i, s),
                y(e) ? (r(y(t), "notes must be an array when duration is array"),
                t.forEach((t,n)=>{
                    const s = e[Math.min(n, e.length - 1)];
            ...
            add(t, e, n) {
                if (r(x(t) || isFinite(t), "note must be a pitch or midi: " + t),
                x(t)) {
                ...
                this._state.forEachFrom(t, t=>{
                    ...
                    if ("started" === t.state) {
                        ...
                        if (!0 === this._loop || m(this._loop) && this._loop > 1) {
                            ...
                            t.id = this.context.transport.schedule(this._tick.bind(this), new Lt(this.context,n))
                    }
                }
                )
            }
        ...
        class gn extends _n {
            ...
            _startNote(t, e, n) {
                ...
                t.start(new Lt(this.context,e))) : t.startOffset < this._loopStart && t.startOffset >= n && (t.loop = !1,
                t.start(new Lt(this.context,e))) : t.startOffset >= n && t.start(new Lt(this.context,e))
            }
            get startOffset() {
                return this._startOffset
            }
            ...
            at(t, e) {
                ...
                for (; !o.done; ) {
                    ...
                    if (Math.abs(n - t.startOffset) < s)
                        return f(e) && (t.value = e),
                        t;
                    o = i.next()
                }
                return f(e) ? (this.add(t, e),
                this.at(t)) : null
            }
            add(t, e) {
                ...
                const n = this.toTicks(t);
                let s;
                return e instanceof _n ? (s = e,
                s.callback = this._tick.bind(this)) : s = new _n({
                    callback: this._tick.bind(this),
                    context: this.context,
                    value: e
                }),
            ...
            remove(t, e) {
                return g(t) && t.hasOwnProperty("time") && (t = (e = t).time),
                t = this.toTicks(t),
                this._events.forEach(n=>{
                    n.startOffset === t && (p(e) || f(e) && n.value === e) && (this._events.delete(n),
                    n.dispose())
                }
                ),
                this
        ...
        function *Cn(t, e="up", n=0) {
            switch (r(t.length > 0, "The array must have more than one value in it"),
            e) {
            case "up":
                yield*bn(t, vn);
            case "down":
        ...
        class kn extends mn {
            constructor() {
                super(q(kn.getDefaults(), arguments, ["callback", "values", "pattern"])),
                this.name = "Pattern";
            ...
            set pattern(t) {
                this._type = t,
                this._pattern = Cn(this._values, this._type)
            }
        }
        class An extends _n {
            constructor() {
                super(q(An.getDefaults(), arguments, ["callback", "events", "subdivision"])),
                this.name = "Sequence",
                this._part = new gn({
            ...
            _createSequence(t) {
                return new Proxy(t,{
                    get: (t,e)=>t[e],
                    set: (t,e,n)=>(b(e) && isFinite(parseInt(e, 10)) && y(n) ? t[e] = this._createSequence(n) : t[e] = n,
                    this._eventsUpdated(),
                    !0)
                })
            }
        ...
        class En extends jn {
            constructor() {
                super(q(En.getDefaults(), arguments, ["frequency", "baseFrequency", "octaves"])),
        ...
        class Fn extends Mn {
            constructor() {
                super(q(Fn.getDefaults(), arguments, ["baseFrequency", "octaves", "sensitivity"])),
                this.name = "AutoWah";
        ...
        class Pn extends Mn {
            ...
            _getCoefficient(t, e, n) {
                return n.has(e) || (0 === e ? n.set(e, 0) : 1 === e ? n.set(e, t) : n.set(e, 2 * t * this._getCoefficient(t, e - 1, n) - this._getCoefficient(t, e - 2, n))),
                n.get(e)
            }
            get order() {
                return this._order
        ...
        class Bn extends Ct {
            constructor(t) {
                ...
                this._dryWet = this.output = new Dn({
                    context: this.context,
                    fade: t.wet
                }),
                this.wet = this._dryWet.fade,
        ...
        class Un extends Wn {
            constructor() {
                super(q(Un.getDefaults(), arguments, ["frequency", "delayTime", "depth"])),
                this.name = "Chorus";
        ...
        class Jn extends Bn {
            constructor() {
                ...
                this._combFilters = Hn.map((e,n)=>{
                    ...
                    return n < Hn.length / 2 ? this.connectEffectLeft(s, ...this._allpassFiltersL) : this.connectEffectRight(s, ...this._allpassFiltersR),
        ...
        class ns extends Bn {
            constructor() {
                ...
                this._feedbackCombFilters = Kn.map((t,e)=>{
                    ...
                    return this._scaleRoomSize.connect(n.resonance),
                    n.resonance.value = ts[e],
                    e < Kn.length / 2 ? this.connectEffectLeft(...this._allpassFilters, n) : this.connectEffectRight(...this._allpassFilters, n),
                    n
                }
                ),
        ...
        class os extends Yn {
            ...
            set pitch(t) {
                ...
                e = ut(t - 1) + 1) : (this._lfoA.min = this._windowSize,
                this._lfoA.max = 0,
        ...
        class rs extends Bn {
            constructor() {
                super(q(rs.getDefaults(), arguments, ["frequency", "octaves", "baseFrequency"])),
                this.name = "Phaser";
        ...
        class ms extends _s {
            ...
            getLevel() {
                return d("'getLevel' has been changed to 'getValue'"),
                this.getValue()
            }
            getValue() {
                const t = this._analyser.getValue()
                  , e = (1 === this.channels ? [t] : t).map(t=>{
                    ...
                    return this._rms = Math.max(n, this._rms * this.smoothing),
        ...
        class gs extends _s {
            constructor() {
                super(q(gs.getDefaults(), arguments, ["size"])),
                this.name = "FFT";
            ...
            getFrequencyOfIndex(t) {
                return r(0 <= t && t < this.size, "index must be greater than or equal to 0 and less than " + this.size),
        ...
        class bs extends Ct {
            constructor() {
                super(q(bs.getDefaults(), arguments, ["solo"])),
                this.name = "Solo";
                const t = q(bs.getDefaults(), arguments, ["solo"]);
                this.input = this.output = new Mt({
                    context: this.context
                }),
                bs._allSolos.has(this.context) || bs._allSolos.set(this.context, new Set),
            ...
            _addSolo() {
                bs._soloed.has(this.context) || bs._soloed.set(this.context, new Set),
        ...
        class Ts extends Ct {
            constructor() {
                super(q(Ts.getDefaults(), arguments, ["lowFrequency", "highFrequency"])),
        ...
        class Ss extends Ct {
            constructor() {
                super(q(Ss.getDefaults(), arguments, ["positionX", "positionY", "positionZ"])),
                this.name = "Panner3D";
        ...
        class Cs extends Ct {
            ...
            pause() {
                return r("started" === this.state, "Recorder must be started"),
        ...
        class As extends Ct {
            constructor() {
                super(Object.assign(q(As.getDefaults(), arguments, ["threshold", "smoothing"]))),
                this.name = "Gate";
